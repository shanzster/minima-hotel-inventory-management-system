...
export default function PurchasingLoginPage() {
  const [email, setEmail] = useState('purchasing@minima.com')
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-full" 
              ...
              <svg className="w-8 h-8" style={{ color: 'var(--black)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h1 className="text-2xl font-heading font-medium mb-2" style={{ color: 'var(--black)' }}>
              Purchasing Officer Portal
            </h1>
          ...
          <div className="mt-8 text-center">
            <div className="inline-block px-6 py-4 rounded-lg border border-gray-200 bg-white/50 backdrop-blur-sm">
              ...
              <p className="text-xs" style={{ color: 'var(--gray-500)' }}>
                <span className="font-medium">purchasing@minima.com</span> / password123
              </p>
            </div>
          </div>
        </div>
