...
export default function KitchenLoginPage() {
  const [email, setEmail] = useState('kitchen@minima.com')
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-sm" style={{ color: 'var(--gray-500)' }}>
              Manage menu items and kitchen operations
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-block px-6 py-4 rounded-lg border border-gray-200 bg-white/50 backdrop-blur-sm">
              ...
              <p className="text-xs" style={{ color: 'var(--gray-500)' }}>
                <span className="font-medium">kitchen@minima.com</span> / password123
              </p>
            </div>
          </div>
        </div>
