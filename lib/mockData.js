...
export const mockInventoryItems = [
  ...
  // Assets - Equipment
  {
    ...
    description: 'Commercial espresso machine for restaurant',
    category: 'equipment',
    type: 'asset',
    currentStock: 1,
    unit: 'unit',
    ...
    supplier: 'Commercial Kitchen Equipment',
    cost: 425000.00, // ₱425,000.00 per unit
    expirationDate: null,
    serialNumber: 'CKE-CM-2023-001',
    condition: 'good',
  ...
  },
  {
    ...
    supplier: 'Kitchen Solutions Inc',
    cost: 600000.00, // ₱600,000.00 per unit
    expirationDate: null,
    serialNumber: 'KSI-DW-2023-002',
    condition: 'excellent',
  ...
  {
    id: 'equipment-003',
    name: 'Vacuum Cleaner Set',
    description: 'Professional vacuum cleaners for housekeeping',
    category: 'equipment',
    type: 'asset',
    currentStock: 3,
    unit: 'unit',
    ...
    cost: 22500.00, // ₱22,500.00 per unit
    expirationDate: null,
    serialNumber: 'CEC-VC-2023-003',
    condition: 'fair',
  ...
  {
    id: 'equipment-004',
    name: 'Front Desk Computer System',
    description: 'Desktop computer for front desk operations',
    category: 'equipment',
    type: 'asset',
    currentStock: 2,
    unit: 'unit',
    ...
    cost: 60000.00, // ₱60,000.00 per unit
    expirationDate: null,
    serialNumber: 'TSL-PC-2023-004',
    condition: 'good',
  ...
  },
  {
    ...
    description: 'Complete tool set for hotel maintenance',
    category: 'equipment',
    type: 'asset',
    currentStock: 1,
    unit: 'set',
    ...
    cost: 40000.00, // ₱40,000.00 per set
    expirationDate: null,
    serialNumber: 'PTI-TK-2023-005',
    condition: 'poor',
